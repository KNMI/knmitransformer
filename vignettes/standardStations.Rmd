...
User definied stations, such as the data set in this example for daily temperature data set, which was downloaded from the [Climate Explorer](https://climexp.knmi.nl/selectdailyseries.cgi?id=someone@somewhere) will need some actions beforehand.
...
For such data sets we will need to define an extra date column, provide latitutde and longitude details, and select an appropriate base period of 30 years, where a 30 year period is important for statistical stability. Keep in mind that the transformation programme was written with the base period 1981 - 2010 in mind.
